...
namespace precise {
    ...
    static UNITS_CPP14_CONSTEXPR_OBJECT std::array<unitD, 2088> r20_units = {{
        ...
        unitD{"FD", "million particle per cubic foot", {mega*count / ft.pow(3),commodities::particle},
        ...
        unitD{"H85", "reciprocal week", time::week.inv()},
             unitD{"H87", "piece", {one, commodities::piece}},
