...
UNITS_CPP14_CONSTEXPR_OBJECT std::array<
    ...
    defined_unit_strings_si{{
        ...
        {"EQ", precise::mol},
        {"osm", precise_unit(1.0, precise::mol, commodities::particle)},
        {"osmole", precise_unit(1.0, precise::mol, commodities::particle)},
        {"osmol", precise_unit(1.0, precise::mol, commodities::particle)},
        {"OSM", precise_unit(1.0, precise::mol, commodities::particle)},
...
UNITS_CPP14_CONSTEXPR_OBJECT std::array<
    ...
    defined_unit_strings_customary{{
        ...
        {"[HP_X]",
         {1.0, precise::log::neglog10, commodities::Hahnemann}},
        {"[hp_C]",
         {1.0, precise::log::neglog100, commodities::Hahnemann}},
        {"[HP_C]",
         {1.0, precise::log::neglog100, commodities::Hahnemann}},
        {"[hp_M]",
         {1.0, precise::log::neglog1000, commodities::Hahnemann}},
        {"[HP_M]",
         {1.0, precise::log::neglog1000, commodities::Hahnemann}},
        {"[hp_Q]",
         {1.0, precise::log::neglog50000, commodities::Hahnemann}},
        {"[HP_Q]",
         {1.0, precise::log::neglog50000, commodities::Hahnemann}},
        {"[kp_X]",
         {1.0, precise::log::neglog10, commodities::Korsakov}},
        {"[KP_X]",
         {1.0, precise::log::neglog10, commodities::Korsakov}},
